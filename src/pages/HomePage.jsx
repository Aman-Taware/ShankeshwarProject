    ...
    <div className="bg-cream min-h-screen">
      ...
      <section className="py-16 bg-sage-teal/5">
        <Container>
          ...
          {/* Upcoming Projects */}
          {upcomingProperties && upcomingProperties.length > 0 && (
            <motion.div 
              className="mb-20"
            ...
            >
              <div className="flex justify-between items-end mb-8">
                ...
                {getPropertiesByStatus(PROPERTY_STATUS.UPCOMING.value).length > 3 && (
                  <Button href="/projects/all?filter=upcoming" variant="ghost" size="sm" className="hidden md:inline-flex">
                    View All
                  </Button>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                {upcomingProperties.map((property, index) => (
                  ...
                  >
                    <PropertyCard property={property} index={index} isUpcomingProperty={true} />
                  </motion.div>
                ))}
              </div>
              ...
              {getPropertiesByStatus(PROPERTY_STATUS.UPCOMING.value).length > 3 && (
                <div className="text-center mt-10 md:hidden">
                  <Button href="/projects/all?filter=upcoming" variant="outline" size="lg" animation="bounce">
            ...
            >
              <div className="flex justify-between items-end mb-8">
                ...
                {getPropertiesByStatus(PROPERTY_STATUS.UNDER_CONSTRUCTION.value).length > 3 && (
                  <Button href="/projects/all?filter=ongoing" variant="ghost" size="sm" className="hidden md:inline-flex">
                    View All
                  </Button>
                )}
              </div>
              ...
              {getPropertiesByStatus(PROPERTY_STATUS.UNDER_CONSTRUCTION.value).length > 3 && (
                <div className="text-center mt-10 md:hidden">
                  <Button href="/projects/all?filter=ongoing" variant="outline" size="lg" animation="bounce">
            ...
            >
              <div className="flex justify-between items-end mb-8">
                <h2 className="text-3xl md:text-4xl font-display text-deep-teal">
                  <span className="relative inline-block">
                    Completed Projects
                    <span className="absolute bottom-0 left-0 w-full h-1 bg-green-600/30 rounded-full"></span>
                  </span>
                </h2>
                {getPropertiesByStatus(PROPERTY_STATUS.COMPLETED.value).length > 3 && (
                  <Button href="/projects/all?filter=completed" variant="ghost" size="sm" className="hidden md:inline-flex">
                    View All
                  </Button>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                {completedProperties.map((property, index) => (
                  <motion.div
                    ...
                    transition={{ duration: 0.5, delay: index * 0.1 }}
                  >
                    <PropertyCard property={property} index={index} isCompletedProperty={true} />
                  </motion.div>
                ))}
              </div>
              ...
              {getPropertiesByStatus(PROPERTY_STATUS.COMPLETED.value).length > 3 && (
                <div className="text-center mt-10 md:hidden">
                  <Button href="/projects/all?filter=completed" variant="outline" size="lg" animation="bounce">
          ...
          <div className="text-center mt-12">
            <Button href="/projects/all" variant="primary" size="lg" animation="bounce">
        ...
        <Container>
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-display text-deep-teal mb-6">
              Welcome to <span className="text-amber-gold">Shankeshwar Buildcorp</span>
            </h2>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
              ...
              <motion.div 
                ...
                whileHover={{ y: -5 }}
              >
                <div className="absolute inset-0 bg-gradient-to-t from-deep-teal/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                <div className="w-16 h-16 rounded-full bg-white/20 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 pointer-events-none">
                ...
                <Button variant="outline" size="sm" href="/projects/all" className="mt-auto relative z-10 pointer-events-auto" animation="bounce">
                  Explore Homes
                </Button>
              </motion.div>
              ...
              <motion.div 
                ...
                whileHover={{ y: -5 }}
              >
                <div className="absolute inset-0 bg-gradient-to-t from-sage-teal/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                <div className="w-16 h-16 rounded-full bg-sage-teal/20 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 pointer-events-none">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-deep-teal" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <motion.div 
                ...
                whileHover={{ y: -5 }}
              >
                <div className="absolute inset-0 bg-gradient-to-t from-amber-gold/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                <div className="w-16 h-16 rounded-full bg-amber-gold/20 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 pointer-events-none">
                ...
                <Button variant="accent" size="sm" href="/projects/all" className="mt-auto relative z-10 pointer-events-auto" animation="bounce">
                  Invest Now
                </Button>
              </motion.div>
              
              {/* Add Redevelopment Card */}
              <motion.div 
                className="bg-amber-gold/90 p-8 rounded-lg shadow-lg text-center hover:shadow-xl transition-all duration-300 group relative overflow-hidden"
                whileHover={{ y: -5 }}
              >
                <div className="absolute inset-0 bg-gradient-to-t from-deep-teal/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                <div className="w-16 h-16 rounded-full bg-deep-teal/20 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 pointer-events-none">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-deep-teal" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                  </svg>
                </div>
                <h3 className="text-2xl font-display text-deep-teal mb-4">Redevelopment Projects</h3>
                <p className="text-deep-teal/90 mb-6">Transform your society with our expert redevelopment solutions, adding value and modern amenities.</p>
                <Button variant="outline" size="sm" href="/projects/all" className="mt-auto bg-deep-teal text-white hover:bg-deep-teal/90 border-deep-teal relative z-10 pointer-events-auto" animation="bounce">
                  Learn More
                </Button>
              </motion.div>
            </div>
