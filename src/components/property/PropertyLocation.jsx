                      ...
                      <div className="pt-4 mt-4 border-t border-gray-100">
                        ...
                        {place.rating && (
                          <div className="flex items-center mb-3">
                            <div className="text-sm font-medium mr-2">Rating:</div>
                            <div className="flex items-center">
                              {[...Array(5)].map((_, i) => (
                                <svg key={i} className={`w-4 h-4 ${i < Math.floor(place.rating) ? 'text-amber-gold' : 'text-gray-300'}`} fill="currentColor" viewBox="0 0 20 20">
                                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                </svg>
                              ))}
                              <span className="ml-1 text-sm text-gray-600">{place.rating}/5</span>
                            </div>
                          </div>
                        )}
                        ...
                        <div className="flex items-center justify-between">
                          {place.url && (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="inline-flex items-center text-amber-gold hover:text-deep-teal text-sm font-medium"
                            >
                              Visit Website
                              <FaExternalLinkAlt className="ml-1 text-xs" />
                            </a>
                          ...
                          <a
                            href={`https://maps.google.com/maps?q=${place.name}`}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center text-deep-teal hover:text-amber-gold text-sm font-medium"
                          >
                            View on Map
                            <FaMapMarkedAlt className="ml-1 text-xs" />
                          </a>
                        </div>
                      </div>
                    </motion.div>
